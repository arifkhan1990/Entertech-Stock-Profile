...
Route::middleware('auth')->group(function() {
    ...
    Route::controller(AdminController::class)->group(function() {
        ...
        Route::get('user-accounts', 'userAccounts')->name('user-accounts');
        Route::get('group-account', 'groupAccount')->name('group-account');

        // Market data route
        Route::get('market-news-data', 'marketNewsData')->name('market-news-data');
        Route::get('market-events-data', 'marketEventsData')->name('market-events-data');
        Route::get('market-category-data', 'marketCategoryData')->name('market-category-data');
        Route::get('market-industry-data', 'marketIndustryData')->name('market-industry-data');
        Route::get('market-company-data', 'marketCompanyData')->name('market-company-data');

        // Circuit Breaker route
        Route::get('dse', 'dseData')->name('dse');
        Route::get('cse', 'cseData')->name('cse');
