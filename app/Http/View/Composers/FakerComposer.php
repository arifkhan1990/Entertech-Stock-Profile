...
class FakerComposer
{
    public function fakeUsers()
    {
        ...
        return $users->random(3)->map(function ($user) {
            return [
                'name' => $user['name'],
                'gender' => $user['gender'],
                'email' => strtolower(str_replace(' ', '', $user['name']) . '@entertech.com')
            ];
        });
    }
    ...
    public function fakePhoneNumber()
    {
        $phoneNumber = [];
        for ($i = 0; $i < 15; $i++) {
            $phoneNumber[] = '+880' . rand(1000000, 99999999);
        }
        return collect($phoneNumber)->random(10);
    }
    ...
    public function fakeNumber()
    {
        $number = [];
        for ($i = 0; $i < 15; $i++) {
            $number[] = rand(1, 15);
        }
        return collect($number)->random(10);
    }
    ...
    public function fakeUserType()
    {
        return collect(['Admin', 'Client'])->random(1);
    }
    ...
    public function fakeClientCode()
    {
        $code = [];
        for ($i = 0; $i < 15; $i++) {
            $code[] = rand(100000, 999999);
        }
        return collect($code)->random(10);
    }
    ...
    public function compose(View $view)
    {
        ...
        for ($i = 0; $i < 20; $i++) {
            $fakerData[] = [
                ...
                'numberAc' => $this->fakeNumber(),
                'clientCode' => $this->fakeClientCode()
            ];
        }
