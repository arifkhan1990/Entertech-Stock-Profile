...
{{-- <div class="shadow-md fixed bottom-0 right-0 box border rounded-full h-12 px-5 flex items-center justify-center z-50 mb-10 mr-52">
    ...
    <a href="{{ route('color-scheme-switcher', ['color_scheme' => 'theme-5']) }}" class="block w-8 h-8 cursor-pointer bg-red-900 rounded-full border-4 hover:border-slate-200 {{ $color_scheme =='theme-5' ? 'border-slate-300 dark:border-darkmode-800/80' : 'border-white dark:border-darkmode-600' }}"></a>
</div> --}}
