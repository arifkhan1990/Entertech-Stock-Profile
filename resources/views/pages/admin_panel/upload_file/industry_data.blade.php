...
@section('subhead')
    <title>Upload Industry Data File - Entertech</title>
@endsection
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y box col-span-12 2xl:col-span-6 bg-primary">
            <div class="flex flex-row items-start p-5">
                <h2 class="text-xl font-medium items-start font-semibold text-white">All Industry Data Uploaded File.</h2>
            </div>
        </div>
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                ...
                <div class="w-full sm:w-auto flex">
                    <button class="btn btn-primary shadow-md mr-2">
                        ...
                        <span>Upload Industry Data Files <br />
